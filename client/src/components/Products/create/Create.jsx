      ...
      <form ref={createRef} id="create" onSubmit={createProductSubmitHandler}>
        <div className="container">
          ...
          <input
            type="text"
            id="category"
            defaultValue={createValues.category}
            onChange={createChangeHandler}
          />
          ...
          <input
            type="text"
            id="imageUrl"
            defaultValue={createValues.imageUrl}
            onChange={createChangeHandler}
          />
          ...
          <input
            type="number"
            id="price"
            defaultValue={createValues.price}
            onChange={createChangeHandler}
          ...
          <input
            type="number"
            id="width"
            defaultValue={createValues.width}
            onChange={createChangeHandler}
          ...
          <input
            type="number"
            id="depth"
            defaultValue={createValues.depth}
            onChange={createChangeHandler}
          ...
          <input
            type="number"
            id="height"
            defaultValue={createValues.height}
            onChange={createChangeHandler}
