(function (global, factory) {
  ...
  var furniture = userService.parseRequest;
    ...
    return function decorateContext(context, request) {
      ...
      function register(body) {
        if (
          ...
          context.protectedStorage.query("furniture", {
          ...
          const result = context.protectedStorage.add("furniture", newUser);
          delete result.hashedPassword;
      ...
      function login(body) {
        const targetUser = context.protectedStorage.query("furniture", {
          [identity]: body[identity],
        });
  ...
  var protectedData = {
    furniture: {
      "7e5cdf1c-878d-4184-a0e0-893b0002ccda": {
        name: "KIVIK",
        category: "Sofa",
        price: "749.00",
        imageUrl:
      ...
      "701df2fd-8348-4e6d-ba28-e470042c15d7": {
        name: "FINNALA",
        category: "Sofa",
        price: "1,149.00",
        imageUrl:
      ...
      "bc467258-c3c1-47ab-9a13-004fb095b408": {
        name: "LINANÄS",
        category: "Sofa",
        price: "749.00",
        imageUrl:
      ...
      "1c301890-569c-4a97-b56b-745024debaac": {
        name: "GAMMALBYN",
        category: "Sofa",
        price: "499.00",
        priceBefore: "699.00",
        imageUrl:
          "https://www.ikea.com/us/en/images/products/gammalbyn-sofa-gray__0868926_pe781434_s5.jpg?f=xl",
      },
      "0260e328-61b2-4f7e-8a59-0efffd7ebbe3": {
        name: "ÄPPLARYD",
        category: "Sofa",
        price: "1,149.00",
        imageUrl:
          "https://www.ikea.com/us/en/images/products/aepplaryd-sofa-lejde-gray-black__0992907_pe820325_s5.jpg?f=xl",
      },
      "4cb1b921-5777-4034-94b8-0facda41fe59": {
        name: "MORABO",
        category: "Sofa",
        price: "1,199.00",
        imageUrl:
          "https://www.ikea.com/us/en/images/products/morabo-sofa-with-chaise-gunnared-dark-gray-wood__0602368_pe680306_s5.jpg?f=xl",
      },
      "a4de47ac-1473-4122-8bb9-d84787099a79": {
        name: "EKEDALEN",
        category: "Table",
        price: "239.99",
        priceBefore: "299.00",
        imageUrl:
          "https://www.ikea.com/us/en/images/products/ekedalen-extendable-table-dark-brown__0736963_pe740827_s5.jpg?f=xl",
      },
      "0c9c98d9-a2a4-401b-823b-863b9fb050e7": {
        name: "INGATORP",
        category: "Table",
        price: "399.99",
        priceBefore: "499.99",
      ...
      "8793cbc1-8e5f-4e06-8383-0afe19772dcb": {
        name: "LISABO",
        category: "Table",
        price: "199.99",
        priceBefore: "249.99",
      ...
      "a4ea39cb-c484-40d4-ad53-b932f3b5d1de": {
        name: "NORDEN",
        category: "Table",
        price: "279.99",
        priceBefore: "349.99",
      ...
      "39d2d347-2657-4ee9-93e7-f7bbfd276b95": {
        name: "TARSELE",
        category: "Table",
        price: "559.00",
        priceBefore: "699.00",
